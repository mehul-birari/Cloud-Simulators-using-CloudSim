...
public class RoundRobinVmAllocationTimeShared_1DC {
    ...
    public static void main(String args[]) {
        ...
        new RoundRobinVmAllocationTimeShared_1DC();
    }



    private RoundRobinVmAllocationTimeShared_1DC() {
    ...
    private List<Vm> createVms(CloudletSchedulerTimeShared csts) {
        ...
        for(int i=0; i < vms; i++) {
            ...
            vm.setRam(ram).setBw(bw).setSize(storage).setCloudletScheduler(csts);
            list.add(vm);
        }
        return list;
    }
