...
public class RoundRobinVmAllocation_2DC {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RoundRobinVmAllocation_2DC.class.getSimpleName());
    ...
    public static void main(String args[]) {
        ...
        new RoundRobinVmAllocation_2DC();
    }



    private RoundRobinVmAllocation_2DC() {
